...
func (x *Bootstrap) GetDataSource() *DataSource {
	if x != nil {
		return x.DataSource
	}
	return nil
...
type DataSource struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	HttpTimeout   *durationpb.Duration   `protobuf:"bytes,1,opt,name=http_timeout,json=httpTimeout,proto3" json:"http_timeout,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DataSource) GetHttpTimeout() *durationpb.Duration {
	if x != nil {
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"kratos.api\x1a\x1egoogle/protobuf/duration.proto\"\x96\x01\n" +
	"\tBootstrap\x12*\n" +
	"\x06server\x18\x01 \x01(\v2\x12.kratos.api.ServerR\x06server\x12$\n" +
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\x127\n" +
	"\vdata_source\x18\x03 \x01(\v2\x16.kratos.api.DataSourceR\n" +
	"dataSource\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"J\n" +
	"\n" +
	"DataSource\x12<\n" +
	"\fhttp_timeout\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\vhttpTimeoutB\x1fZ\x1deino-stock/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Bootstrap.data_source:type_name -> kratos.api.DataSource
	...
	8,  // 7: kratos.api.DataSource.http_timeout:type_name -> google.protobuf.Duration
